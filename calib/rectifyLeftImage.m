function [rectifiedImage] = rectifyLeftImage(distortedImage, rectifiedImageWidth, rectifiedImageHeight, topLeftRectifiedColumn, topLeftRectifiedRow, stereoParameters)
    ...
    firstDistortionCoefficient = stereoParameters.CameraParameters1.RadialDistortion(1);
    secondDistortionCoefficient = stereoParameters.CameraParameters1.RadialDistortion(2);
    ...
    homography = (leftIntrinsicMatrix + rightIntrinsicMatrix) / 2 * [newXAxisVector; newYAxisVector; newZAxisVector] / leftIntrinsicMatrix;
    partialInverseHomography = eye(3) / leftIntrinsicMatrix / homography;
    ...
    for rectifiedImageRow = 1 : rectifiedImageHeight
        for rectifiedImageColumn = 1 : rectifiedImageWidth
            ...
            distortedImageCoord = leftIntrinsicMatrix * distortedCoord;
